...
void MX_ADC3_Init(void)
{
  ...
  */
  ...
  sConfig.Rank = ADC_REGULAR_RANK_1;
  sConfig.SamplingTime = ADC3_SAMPLETIME_92CYCLES_5; //ADC3_SAMPLETIME_2CYCLES_5;
  sConfig.SingleDiff = ADC_SINGLE_ENDED;
  sConfig.OffsetNumber = ADC_OFFSET_NONE;
  sConfig.Offset = 0;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PF11     ------> ADC1_INP2
    */
    GPIO_InitStruct.Pin = C_port_4_Pin|C_port_5_Pin|C_port_6_Pin|C_port_7_Pin
                          |C_port_0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = C_port_1_Pin|C_port_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = C_port_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(C_port_3_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PC0     ------> ADC3_INP10
    */
    GPIO_InitStruct.Pin = V_main_Pin|V_acu_Pin|C_ext_B_Pin|C_ext_BF9_Pin
                          |C_main_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = C_core_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(C_core_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(GPIOA, C_port_4_Pin|C_port_5_Pin|C_port_6_Pin|C_port_7_Pin
                          |C_port_0_Pin);

    HAL_GPIO_DeInit(GPIOB, C_port_1_Pin|C_port_2_Pin);

    HAL_GPIO_DeInit(C_port_3_GPIO_Port, C_port_3_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC0     ------> ADC3_INP10
    */
    HAL_GPIO_DeInit(GPIOF, V_main_Pin|V_acu_Pin|C_ext_B_Pin|C_ext_BF9_Pin
                          |C_main_Pin);

    HAL_GPIO_DeInit(C_core_GPIO_Port, C_core_Pin);
